module.exports = function() {
    return actor({
      ...
      includeGroup: function(includeGroupName) {
        ...
        this.fillField("#adForddm > div > div:nth-child(5) > div > div > div > div > div.group-unit__container > div:nth-child(2) > div > div > div.multiselect__tags > input",includeGroupName)
        this.wait(3)
