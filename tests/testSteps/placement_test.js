module.exports = function() {
    return actor({
      //include group 입력
      includeGroup: function(includeGroupName, placementPath) {
        ...
        //this.click(placementPath+" > div > div > div > div > div.group-unit__container > div:nth-child(2) > div > div > div.multiselect__tags > span")
        this.fillField(placementPath+" > div > div > div > div > div.group-unit__container > div:nth-child(2) > div > div > div.multiselect__tags > input",includeGroupName)
        this.wait(3)
